...
> **[SUPERSEDED — 14.08.2026]** Активний план виконання — [`EXPLORATION-SLICE-WORKFLOW.md`](./EXPLORATION-SLICE-WORKFLOW.md), побудований на замороженому дизайні в [`docs/design/exploration-v0.1/`](./design/exploration-v0.1/). Нові фази брати **звідти**, не звідси.
>
> Що з цього файлу переїхало й лишається живим:
>
> - **Фаза A0 (seeded RNG)** — так і не зроблена, втягнута у фазу **E0** нового воркфлову як передумова детермінізму всього слайсу.
> - **Частина 1** (категорії контенту, «наглядач», «кожна механіка — окрема тактична гра», спліт-скрін) — дизайнерські принципи лишаються чинними й новим воркфловом не скасовані.
> - **Фаза 0 (спліт-скрін UI)** — чекає на референс, не заблокована новим планом.
>
> Що замінене: фази **A–I** (вибір токена, кемп, тактичне планування шляху, взаємодія з обʼєктами, годинник раунду, токени навичок, кубики, картки) — їхній предмет перекритий фазами E1–E9 нового воркфлову або свідомо винесений за межі слайсу. Цей файл лишається як історія рішень; редагувати його не треба.
