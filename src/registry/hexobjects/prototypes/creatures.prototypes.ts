...
export const CREATURE_PROTOTYPES: Record<TCreatureKeys, THexobjectPrototype> = {
    [HEXOBJECT_KEYS.SKELETOR]: {
        ...
        creature: { name: 'Skeletor', hp: 30, hpMax: 30, faction: "enemy", visionRange: 3 },
    ...
    [HEXOBJECT_KEYS.EMITTER]: {
        ...
        creature: { name: 'Emmiter', hp: 30, hpMax: 30, faction: "enemy", visionRange: 3 },
        collision: EHexCollision.SOLID,
    ...
    [HEXOBJECT_KEYS.INFERNO]: {
        ...
        creature: { name: 'Inferno', hp: 100, hpMax: 100, faction: "enemy", visionRange: 4 },
        collision: EHexCollision.SOLID,
