...
<!--<script lang="ts">-->
<!--import ShopSlotsGrid from "back-up/scenes/shop-scene/components/shop-slots-grid.vue";-->
<!--import ShopModeSwitcher from "back-up/scenes/shop-scene/components/shop-mode-switcher.vue";-->
<!--import TradeSlotsGrid from "back-up/scenes/shop-scene/components/trade-slots-grid.vue";-->
...
<!--<style>-->
<!--@import "../styles/shop-modal-style.css";-->
<!--</style>-->